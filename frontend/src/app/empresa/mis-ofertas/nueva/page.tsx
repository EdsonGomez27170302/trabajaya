        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
            ...
            <div className="rounded-2xl border border-border bg-muted/40 p-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="contact_email">Correo de contacto <span className="text-muted-foreground text-xs">(opcional)</span></Label>
                <Input
                  id="contact_email"
                  type="email"
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="contact_address">Dirección <span className="text-muted-foreground text-xs">(opcional)</span></Label>
                <Input
                  id="contact_address"
