...
import { JobDetailModalHeader } from "./job-detail-modal-header";
import { JobDetailModalStats } from "./job-detail-modal-stats";
import { JobDetailModalContact } from "./job-detail-modal-contact";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <JobDetailModalHeader job={job} />
        <h2 className="mt-4 text-2xl font-black text-foreground">{job.title}</h2>
        <JobDetailModalStats job={job} />
        <JobDetailModalContact job={job} />
      </div>
    </div>
  );
}
